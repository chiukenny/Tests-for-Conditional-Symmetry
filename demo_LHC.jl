## DEMO: Test for SO(2)-equivariance on LHC dijet data
## ---------------------------------------------------
##
...
# Paths
dir_out_dat = "./outputs/data/"  # Path to demo_LHC.h5 (created by preprocess_data.jl)
...
fid = h5open(dir_out_dat*"demo_LHC.h5", "r")
LHC = copy(read(fid["data"]))
close(fid)

n = 100
demo_data = Data(n, x=LHC[1:2,:], y=LHC[3:4,:])
